...
:: ============================================
:: BUOC 3: Cai dat thu vien (npm install)
:: ============================================
echo.
echo [3/4] Dang cai dat tat ca thu vien can thiet...
...
:: ============================================
:: BUOC 4: Cai dat Playwright browsers
:: ============================================
echo.
echo [4/4] Dang cai dat trinh duyet tu dong (Playwright)...
